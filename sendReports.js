...
function reportSender(){
    ...
    this.init = function(){
        ajax.getReq(constant.DHIS_URL_BASE + "/api/userGroups/"+constant.EMAIL_GROUP_UID+"?fields=id,users[id,name,email]",constant.auth,function(error,response,body){
            if (error){
            ...
            var name = "DR1-AFI_"+today+".pdf";
            var reportPathAndName= DEST_PATH_BASE + name;

            var emailUrl =  BASE_URL+"/dhis-web-maintenance-dataadmin/sendEmail.action?subject=DR1-AFI%20Report%20&body=Dear%20Sir,%20PFA%20report.%20Thanks&attachmentLocation="+reportPathAndName+"&email_address_to="+emailStr+"&email_address_cc="+emailStr;
            ...
            name = "DR1-ADD_"+today+".pdf";
            reportPathAndName= DEST_PATH_BASE + name;
            emailUrl =  BASE_URL+"/dhis-web-maintenance-dataadmin/sendEmail.action?subject=DR1-AFI%20Report%20&body=Dear%20Sir,%20PFA%20report.%20Thanks&attachmentLocation="+reportPathAndName+"&email_address_to="+emailStr+"&email_address_cc="+emailStr;
